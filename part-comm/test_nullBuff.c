 ...
 *
 * Shows the behavior of the communication when the buffer is empty 
 */
...
#define PARTITIONS 1
//Count is set to, buffer is empty, 0 elements send/recv per parition
#define COUNT 0
...
if (myrank == 0)
{
	...
	//Iterating through each buffer partition, not really filling anything but marking them ready to send
