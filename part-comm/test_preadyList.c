 ...
 *
 * Shows the behavior of the communication when Pready_list is called and all the are set ready randomly. 
 */
...
if (myrank == 0)
{
	...
	//Iterating through each buffer partition and filling them
		...
		//Adding partitions to a partition array
                partitionsList[i] = i;
        }
	//Marking partitions ready
