 ...
 *
 * Shows the behavior of the communication when using wildcard for recv side source and tag.
...
{
        MPI_Precv_init(message, partitions, COUNT, MPI_DOUBLE, MPI_ANY_SOURCE, MPI_ANY_TAG, MPI_COMM_WORLD, MPI_INFO_NULL, &request);
        MPI_Start(&request);
