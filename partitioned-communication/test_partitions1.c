...
/* 
 * Initializes using an invalid number of partitions: Psend_init with negative partitions.
 *
...
int main(int argc, char *argv[]) {
    ...
    MPI_Count send_partitions = -8; /* Bad number of partitions; MPI_Count is a signed int */
