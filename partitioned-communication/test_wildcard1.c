...
/* 
 * This test attempts to use MPI_ANY_TAG
 *
...
int main(int argc, char *argv[]) {
    ...
    if (0 == myrank) {
        ...
        /* This call should cause error because of MPI_ANY_TAG */
        CHECK_RETVAL(MPI_Precv_init(message, partitions, COUNT, MPI_INT, source, MPI_ANY_TAG, MPI_COMM_WORLD , MPI_INFO_NULL , &request));
