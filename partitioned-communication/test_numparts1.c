 ...
 * 
 * This test has twice as many recv partitions as send partitions
 *
...
int main(int argc, char *argv[]) {
    ...
    MPI_Count send_count = COUNT;
    MPI_Count recv_partitions = PARTITIONS * 2;
    MPI_Count recv_count = (int)COUNT/2;
